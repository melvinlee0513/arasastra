  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 p-4 border-b border-sidebar-border">
        ...
        {!collapsed && (
          <div className="animate-fade-up">
            <h1 className="font-bold text-lg text-sidebar-foreground">StudyOwl</h1>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              />
              {!collapsed && (
                <span className="font-medium animate-fade-up">{item.label}</span>
              )}
              {isActive && !collapsed && (
      ...
      <button
        onClick={onToggle}
        className={cn(
          "m-3 p-2 rounded-xl border border-sidebar-border",
